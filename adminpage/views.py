...
from core.recommender import cleanup_old_mylist_entries, count_old_mylist_entries
...
def dashboard(request):
    ...
    old_entries_count = count_old_mylist_entries()
...
@staff_member_required
def delete_old_mylist(request):
    message = cleanup_old_mylist_entries()
